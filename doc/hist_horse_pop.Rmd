...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. A caption", out.width="100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Another caption", out.width="100%"}
